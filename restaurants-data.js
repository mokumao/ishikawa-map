...
const restaurants = [
  ...
  },
  {
    ...
    closed:    "年中無休",
    note:      "旧「アンサ沖縄リゾート」。2024年12月にIHG・ANAホールディングスが運営受託契約を締結し、2025年初頭にリブランド（住所・電話番号098-963-0123は変更前と一致）。うるま市観光物産協会サイトで新名称にて営業時間を再確認し、チェックアウト時刻を11:00→12:00に修正",
    note_en:   "Formerly \"ANSA Okinawa Resort\". Rebranded in early 2025 after IHG and ANA Holdings signed a hotel management agreement in December 2024 (address and phone number unchanged). Hours re-verified under the new name via the Uruma tourism association site; checkout time corrected from 11:00 to 12:00.",
  ...
  // ── 観光スポット ───────────────────────────────────────────────
  {
    ...
    hours:     "年中無休（自由）",
    closed:    "なし",
    note:      "ウィンドサーフィンで有名な市民ビーチ。リーフ内は砂地で安全。住所は旧「石川曙」表記が出典と不一致だったため2026-08-05に「石川白浜」へ修正（うるま市公式・おきなわ物語で確認。座標付近は字境をまたぎ「石川石崎」表記の情報源もある）",
  ...
  },
  {
    ...
    hours:     "要確認",
    closed:    "要確認",
    note:      "旧店名「スィートハンズ石川店」。公式サイト・ホットペッパービューティー・Instagramで店名変更を確認（住所・電話番号098-964-7717は変更前と一致）。営業時間・定休日は要確認",
    note_en:   "Formerly known as \"Sweet Hands Ishikawa\". Name change confirmed via official site, Hot Pepper Beauty and Instagram (address and phone number unchanged). Please confirm hours and holidays before visiting.",
