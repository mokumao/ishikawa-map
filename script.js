...
L.polygon([
  // OSM町名座標データをもとに作成（各町の中心点＋バッファ）
  [26.453, 127.803],  // 北西（西海岸・北）
  [26.453, 127.823],  // 北（石川岳エリア）
  [26.449, 127.836],  // 北東
  [26.440, 127.843],  // 東北（石川東山方向）
  [26.430, 127.847],  // 東（石川赤崎）
  [26.420, 127.843],  // 東中
  [26.413, 127.840],  // 東南（石川東恩納崎）
  [26.406, 127.831],  // 南東（石川東恩納）
  [26.401, 127.820],  // 南（石川楚南）
  [26.400, 127.810],  // 南西（石川山城方向）
  [26.408, 127.800],  // 西（石川山城・海岸）
  [26.422, 127.799],  // 西（石川嘉手苅・海岸）
  [26.436, 127.801],  // 北西（海岸）
], {
  color:   '#e53935',
  weight:   3,
  opacity:  0.85,
